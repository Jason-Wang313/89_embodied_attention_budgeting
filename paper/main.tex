...
\usepackage{url}
\usepackage{booktabs}
\title{Embodied Attention Budgeting: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about robot foundation model efficiency. The original research bet was: Allocate perception and action attention by physical consequence rather than token salience. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\item HY-Embodied-0.5: Embodied Foundation Models for Real-World Agents (2026)
\item Embodied Intelligence: A Synergy of Morphology, Action, Perception and Learning (2025)
...
\item Aligning Cyber Space with Physical World: A Comprehensive Survey on Embodied AI (2024)
\end{itemize}
