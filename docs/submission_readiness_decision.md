...
Honest strongest claim: `Allocate perception and action attention by physical consequence rather than token salience.` is a plausible branch-structured mechanism for robot foundation model efficiency, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
