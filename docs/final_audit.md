...
1. Chosen thesis: Embodied Attention Budgeting explores `Allocate perception and action attention by physical consequence rather than token salience.` for robot foundation model efficiency.
...
8. Exact Downloads PDF path: `C:/Users/wangz/Downloads/89.pdf`
9. GitHub URL: https://github.com/Jason-Wang313/89_embodied_attention_budgeting
